...
function AdminPlatos() {
  ...
  const borrarPlato = (id) => {
    ...
    axios
      .delete(`http://localhost:3000/api/platos/${id}`)
      .then(() => cargarPlatos())
      .catch((err) => console.error(err));
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (editando) {
      axios
        .put(`http://localhost:3000/api/platos/${platoId}`, formData)
        .then(() => {
          cargarPlatos();
          resetForm();
        });
    } else {
      axios.post("http://localhost:3000/api/platos", formData).then(() => {
        cargarPlatos();
        resetForm();
      });
    }
          ...
          return (
            <div className="accordion-item" key={cat}>
              ...
              <div
                ...
                data-bs-parent="#accordionPlatos"
              >
